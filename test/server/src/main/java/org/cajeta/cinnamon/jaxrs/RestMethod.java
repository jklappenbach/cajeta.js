...
public class RestMethod {
	...
	private List<RestParameter> parameterEntries;
	private Set<String> consumes = new HashSet<String>();
	private Set<String> produces = new HashSet<String>();
	private Map<Class<?>, Converter> parameterConverters = CinnamonRestHandler.getParamConverters();
	...
	public RestMethod(Object instance, String methodName, RestClass classEntry) {
		try {
			Class<?>[] classes = new Class<?>[parameterEntries.size()];
			int i = 0;
			for (RestParameter entry : parameterEntries) {
